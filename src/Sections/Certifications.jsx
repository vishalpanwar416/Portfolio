...
export default function Certifications() {
  ...
  return (
    <section id="certifications" className="py-24 bg-[#0a0a0a] relative overflow-hidden border-t border-gray-800/20">
      {/* Background effects */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="mb-16">
          <motion.h3
            ...
            viewport={{ once: true }}
            className="text-xl sm:text-2xl md:text-3xl font-semibold text-gray-200 mb-6 md:mb-8 flex items-center gap-2"
          >
            <div className="w-1 h-6 md:h-8 bg-gray-500 rounded-full"></div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-2">
                      <h4 className="text-base sm:text-lg font-semibold text-gray-200 group-hover:text-white transition-colors">
                        {cert.title}
                      </h4>
                      {cert.verified && (
